...
fun runCommandAsConsole(request: CallToolRequest, bukkitServer: Server, bukkitPlugin: Plugin): CallToolResult {
    val command = request.arguments["command"]?.jsonPrimitive?.content ?: return CallToolResult(
    ...
    try {
        commandExecutionResult = bukkitServer.scheduler
